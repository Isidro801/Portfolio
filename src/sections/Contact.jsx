...
import { FaMailchimp, FaMapPin, FaPhone, FaRegCircleXmark, FaRegPaperPlane, FaRegCircleCheck } from "react-icons/fa6";
...
const contactInfo = [
  {
    icon: FaMailBulk,
    label: "Email",
    value: "isidroojoseperalta@gmail.com",
    href: "mailto:isidroojoseperalta@gmail.com",
  },
  {
    icon: FaPhone,
    label: "Teléfono",
    value: "+34 679 14 10 32",
    href: "tel:+34679141032",
  },
  {
    icon: FaMapPin,
    label: "Ubicación",
    value: "Granada, España",
    href: "https://maps.google.com/?q=Granada,+España",
  },
];
              ...
              {submitStatus.type && (
                ...
                >
                  {submitStatus.type === "success" ? (
                    ...
                    <FaRegCircleXmark className="w-5 h-5 shrink-0" />
                  )}
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400 w-full">
            ...
            <div className="glass rounded-3xl p-6 sm:p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                Estoy disponible para oportunidades como becario o como algún puesto junior dentro del panorama SOC y de entornos GRC
              </p>
            </div>
          </div>
        </div>
